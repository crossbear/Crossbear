...
pref("crossbear.activateGuard", true);
pref("crossbear.guard.certCacheDefaultValidity", 604800);

pref("crossbear.guard.trustAutomatically", true);
pref("crossbear.guard.ratingToTrustAutomatically", 100);
